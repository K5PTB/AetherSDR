...
void MainWindow::routeCwDecoderOutput()
{
    ...
    if (m_cwDecoderApplet) {
        ...
        disconnect(m_cwDecoderApplet, &PanadapterApplet::decoderModeChanged,
                   &m_cwDecoder, &CwDecoder::setDecoderMode);
    ...
    if (m_cwDecoderApplet) {
        ...
        connect(m_cwDecoderApplet, &PanadapterApplet::speedRangeChanged,
                &m_cwDecoder, &CwDecoder::setSpeedRange);
        connect(m_cwDecoderApplet, &PanadapterApplet::decoderModeChanged,
                &m_cwDecoder, &CwDecoder::setDecoderMode);
